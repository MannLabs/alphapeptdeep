...
__all__ = ['regional_sampling', 'mod_feature_size', 'uniform_sampling', 'ModelRTTransformer', 'EncDecModelRT',
           'AlphaRTModel', 'evaluate_linear_regression', 'evaluate_linear_regression_plot',
...
class AlphaRTModel(model_base.ModelImplBase):
    def __init__(self,
        ...
        model_class:torch.nn.Module=ModelRTTransformer,
        **kwargs,
    ):
        super().__init__()
        self.build(
