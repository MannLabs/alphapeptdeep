...
__all__ = ['InputLSTM', 'InputEmbedding', 'MetaNet', 'HiddenTransformer', 'ModelMSMSpDeep3', 'IntenAwareLoss',
           'pDeepModel', 'mod_feature_size', 'max_instrument_num', 'frag_types', 'max_frag_charge', 'num_ion_types',
           'nce_factor', 'charge_factor', 'pearson', 'spectral_angle', 'spearman', 'evaluate_msms', 'add_cutoff_metric']
...
class IntenAwareLoss(torch.nn.Module):
    def __init__(self, base_weight=0.2, weight_pred=False):
        super().__init__()
        self.w = base_weight
        self.w_pred = weight_pred
