# AUTOGENERATED! DO NOT EDIT! File to edit: nbdev_nbs/nbdev_nbs/_settings.ipynb (unless otherwise specified).

__all__ = ['update_settings', 'global_settings', 'const_settings']
