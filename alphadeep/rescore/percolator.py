...
__all__ = ['fdr_to_q_values', 'calc_fdr', 'score_to_q_value', 'DeepLearningScore', 'Percolator']
...
def calc_fdr(_df, score_column, decoy_column='decoy'):
    _df = _df.reset_index(drop=True)
    _df = _df.sort_values([score_column,decoy_column], ascending=False)
