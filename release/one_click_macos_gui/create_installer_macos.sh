...
pip install "../../dist/peptdeep-1.1.4-py3-none-any.whl[stable]"
...
pkgbuild --root dist/peptdeep --identifier de.mpg.biochem.peptdeep.app --version 1.1.4 --install-location /Applications/peptdeep.app --scripts scripts peptdeep.pkg
