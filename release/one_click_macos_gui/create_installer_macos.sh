...
pkgbuild --root dist/peptdeep --identifier de.mpg.biochem.peptdeep.app --version 0.4.0 --install-location /Applications/peptdeep.app --scripts scripts peptdeep.pkg
