...
pkgbuild --root dist/peptdeep --identifier de.mpg.biochem.peptdeep.app --version 0.2.2 --install-location /Applications/peptdeep.app --scripts scripts peptdeep.pkg
