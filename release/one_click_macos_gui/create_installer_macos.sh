...
pip install "../../dist/peptdeep-0.2.1-py3-none-any.whl[stable]"
...
pkgbuild --root dist/peptdeep --identifier de.mpg.biochem.peptdeep.app --version 0.2.1 --install-location /Applications/peptdeep.app --scripts scripts peptdeep.pkg
