...
pip install "../../dist/peptdeep-0.0.13-py3-none-any.whl[stable]"
...
pkgbuild --root dist/peptdeep --identifier de.mpg.biochem.peptdeep.app --version 0.0.13 --install-location /Applications/peptdeep.app --scripts scripts peptdeep.pkg
