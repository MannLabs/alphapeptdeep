...
pkgbuild --root dist/peptdeep --identifier de.mpg.biochem.peptdeep.app --version 1.0.0 --install-location /Applications/peptdeep.app --scripts scripts peptdeep.pkg
