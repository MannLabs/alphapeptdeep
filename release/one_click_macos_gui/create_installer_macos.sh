...
pip install "../../dist/peptdeep-1.0.1-py3-none-any.whl[stable]"
...
pkgbuild --root dist/peptdeep --identifier de.mpg.biochem.peptdeep.app --version 1.0.1 --install-location /Applications/peptdeep.app --scripts scripts peptdeep.pkg
