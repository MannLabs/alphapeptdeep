...
# BUILD_NAME is taken from environment variables, e.g. peptdeep-1.5.0-macos-darwin-arm64 or peptdeep-1.5.0-macos-darwin-x64
...
pkgbuild --root dist_pyinstaller/${PACKAGE_NAME} --identifier de.mpg.biochem.${PACKAGE_NAME}.app --version 1.5.0 --install-location /Applications/${PACKAGE_NAME}.app --scripts release/macos/scripts ${PACKAGE_NAME}.pkg
