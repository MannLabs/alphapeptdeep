# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbdev_nbs/pretrained_models.ipynb.

# %% auto 0
__all__ = ['pretrain_dir', 'model_zip_name', 'model_url', 'model_zip', 'model_mgr_settings', 'is_model_zip', 'download_models',
