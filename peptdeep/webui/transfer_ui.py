...
def nce_search():
    grid_nce_first = st.number_input(label='Start NCE for grid NCE search',value = global_ui_settings['model_mgr']['transfer']['grid_nce_first']*1.0,step = 1.0)
...
def show():
    ...
    global_ui_settings['model_mgr']['transfer']['model_output_folder'] = model_output_folder
