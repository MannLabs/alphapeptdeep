...
index = {"match_centroid_mz": "match.ipynb",
         ...
         "pearson_correlation": "utils.ipynb",
         "spearman_correlation": "utils.ipynb",
         "add_ms2_similarity_columns": "utils.ipynb",
