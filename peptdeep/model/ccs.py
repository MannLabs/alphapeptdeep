...
class Model_CCS_CustomTransformer(torch.nn.Module):
    """
    Customize a TransformerEncoderLayer for CCS prediction using the BERT Encoder architecture, and invoke it through a TransformerEncoder
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.hidden_nn = model_base.Hidden_PyTorch_TransformerEncoder(
            hidden,
            nlayers=nlayers,
            dropout=dropout,
            output_attentions=output_attentions,
