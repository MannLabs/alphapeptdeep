...
# %% auto 0
__all__ = ['BASE_PATH', 'LOG_PATH', 'log_level_dict', 'uniform_sampling', 'process_bar', 'set_logger', 'show_platform_info',
           'show_python_info', 'parse_ms_file_names_to_dict', 'explode_multiple_columns', 'regional_sampling',
...
def parse_ms_file_names_to_dict(
    ...
    Returns:
        dict: {"raw_name":"/Users/xxx/raw_name.raw", ...}
    """
